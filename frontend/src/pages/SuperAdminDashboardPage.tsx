...
export default function SuperAdminDashboardPage() {
  ...
  const [activeTab, setActiveTab] = useState<"restaurants" | "stats">(
    "restaurants",
  );
    ...
    async (e: FormEvent<HTMLFormElement>) => {
      ...
      try {
        const body: Record<string, unknown> = {
          ...
          openingHoursNote:
            String(editForm.openingHoursNote).trim() || undefined,
        ...
        if (!Number.isNaN(service) && service >= 0)
          body.serviceChargePercent = service;
  ...
  const toggleSuspend = useCallback(
    async (id: string, suspended: boolean) => {
      ...
      try {
        ...
        fetchStats();
        if (editId === id)
          setEditForm((prev) => ({ ...prev, isSuspended: suspended }));
      } catch (err) {
        setError((err as Error).message);
      }
    },
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              ...
              <BarChartCard
                ...
                data={[
                  {
                    name: "Waiter calls",
                    value: stats?.waiterCallsHandledThisWeek ?? 0,
                  },
                  {
                    name: "Chat sessions",
                    value: stats?.chatSessionsThisWeek ?? 0,
                  },
                ]}
            ...
            <form onSubmit={handleEditSubmit} className="space-y-4 p-4">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleEditChange("restaurantType", e.target.value)
                  }
                  className={inputClass}
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleEditChange("openingHoursNote", e.target.value)
                  }
                  className={inputClass}
                />
              </div>
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="space-y-2">
                  <label
                    htmlFor="edit-serviceChargePercent"
              ...
              <div className="space-y-2">
                <label
                  htmlFor="edit-orderLeadTimeMinutes"
                  className={labelClass}
                >
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) =>
                    handleEditChange("allowOrders", e.target.checked)
                  }
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) =>
                    handleEditChange("isSuspended", e.target.checked)
                  }
                  className="h-4 w-4 rounded border-slate-300"
                />
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    handleEditChange("aiInstructions", e.target.value)
                  }
                  className="min-h-[60px] w-full resize-y rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm"
                  rows={2}
                />
        ...
        >
          ...
          >
            ...
            <p className="mt-2 text-xs text-slate-600">
              This will permanently delete the restaurant, its owner account,
              menu, tables, and orders. This cannot be undone.
            </p>
